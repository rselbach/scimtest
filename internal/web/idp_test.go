...
func TestSAMLSSOLoginHintFromSAMLRequestPreselectsUniqueUser(t *testing.T) {
	...
	samlRequest := encodeRedirectSAMLRequest(t, `<samlp:AuthnRequest xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol" xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion"><saml:Subject><saml:NameID>jeff@greendale.community</saml:NameID></saml:Subject></samlp:AuthnRequest>`)
...
func TestSAMLSSOPostBindingLoginHintPreselectsUniqueUser(t *testing.T) {
	...
	form := url.Values{
		"SAMLRequest": {encodeRedirectSAMLRequest(t, `<samlp:AuthnRequest xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol"><samlp:Extensions><LoginHint>jeff@greendale.community</LoginHint></samlp:Extensions></samlp:AuthnRequest>`)},
		"RelayState":  {"relay"},
	}
