	...
	function samlSetupState() {
	  ...
	  return {enabled: true, started: true, configured: true, detail: requestCertificate ? 'Signed requests required' : acsURL, error: ''};
	}
