...
func run(args []string) error {
	...
	maxInstallationsPerUser := fs.Int("max-installations-per-user", 0, "maximum enrolled installations per GitHub user and application (0 = default 2)")
	...
	s, err := server.New(server.Config{
		...
		MaxInstallationsPerUser:  *maxInstallationsPerUser,
